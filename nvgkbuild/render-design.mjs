/* Draw the reconciled Norrfällsviken course from above, to be judged before 3D.
...
const L = [
  ['#3f8a45', 'fairway, green, tee — traced from Esri z18 orthoimagery (0.27 m/px, no registration error)'],
  ['#79d97f', 'green (putting surface); red dot = pin at the surveyed GPS green centre'],
  ['#123b52', 'the sea at 0 m, the perched lake and the tarns each at their measured level'],
  ['#4a5a34', 'the central marsh (OSM wetland)'],
  ['#cbb88a', 'Storsanden and the shore beaches (OSM)'],
];
push(`<g transform="translate(16,${H - 122})">`);
push(`<rect x="-6" y="-16" width="700" height="118" rx="7" fill="#08120c" fill-opacity="0.82"/>`);
push(`<text x="0" y="-2" fill="#eaf3ec" font-size="13" font-weight="700">Norrfällsvikens GK — reconciled layout (card: club scorecard 2025, par 73)</text>`);
L.forEach(([c, t], i) => {
...
[`all 144 card values from the club's own scorecard`,
