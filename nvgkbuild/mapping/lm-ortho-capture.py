"""Intersect published orthophoto seam polygons with each Norrfallsviken review window.
...
report=dict(schemaVersion=1,groundId='norrfallsviken',kind='orthophoto-window-capture-evidence',observedAt=datetime.now(timezone.utc).isoformat(),
...
out=ROOT / 'geo_data/course-v2/norrfallsviken/reference/lm-ortho-capture-2026-09-09.json'
