/* Fetch orthorectified satellite imagery over the cape.
   ...
   tree-cover frame — the course padded out to Storsanden and the fishing
   village — for the canopy classifier, exactly as at Veckefjärden. z18
...
const FRAME17 = { z: 17, x0: -1500, x1: 1200, z0: -1500, z1: 1600 };
/* tracing frame: the 18 holes with a modest ring */
const FRAME18 = { z: 18, x0: -650, x1: 600, z0: -900, z1: 850 };
