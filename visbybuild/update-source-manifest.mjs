...
artifact('numbered-tee-front-nine-review-2026', 'control', 'visbybuild/mapping/lm-tee-review-front9-2026-09-09.json', [...orthoSources, 'club-banguide'], 'Native 2026 imagery and numbered guide labels: three missing physical platforms and seven supported reference corrections. Source hashes, image transforms and unresolved identities retained; no survey or daily marker claims.');
artifact('numbered-tee-back-nine-review-2026', 'control', 'visbybuild/mapping/lm-tee-review-back9-2026-09-09.json', [...orthoSources, 'club-banguide'], 'Native 2026 imagery and current guide labels: eight added platforms, one replacement and supported numbered references. Hole 12 and conflicting hole 14 rear-tee identities remain unresolved.');
artifact('numbered-tee-alignment-adoption-2026', 'control', 'visbybuild/mapping/tee-alignment-review-2026-09-09.json', [...orthoSources, 'club-banguide'], 'Guarded dated adoption ledger with exact previous references, accepted source-pixel targets, and explicitly retained unresolved positions. Only route starts associated with corrected rear references may change.');
artifact('numbered-tee-back-nine-followup-2026', 'control', 'visbybuild/mapping/lm-tee-back9-followup-2026-09-09.json', [...orthoSources, 'club-banguide'], 'Eight unchanged H16/H18 references corroborated against native imagery and guide topology. Together the dated reviews support 75 of 108 numbered-platform associations; 33 remain explicitly unresolved.');
