...
log=root/'docs/graphics/tree-atelier-2026-09-13/species-worker.log'
with log.open('w',encoding='utf-8') as output:
    worker=subprocess.Popen([bpy.app.binary_path,'--background','--factory-startup','--python-exit-code','1',
        '--python',str(root/'tools/blender-tree-study/foliage_species.py')],stdout=output,stderr=subprocess.STDOUT,creationflags=subprocess.CREATE_NO_WINDOW)
