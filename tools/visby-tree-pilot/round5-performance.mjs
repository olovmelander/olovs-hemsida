...
import {OUT,serve,save,json} from './round5-preview.mjs';
const round='round5';
...
const servers={before:await serve('round4'),after:await serve(round||'after')};
...
save(path.join(work,reportPrefix+'-summary.json'),{browser:browser.version(),repeats,hole:16,camera:'tee',viewport:[1440,900],comparison,
 comparisonModes:{before:'round four',after:'round five'},
