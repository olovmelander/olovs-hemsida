...
def main():
    ...
    subprocess.run([sys.executable,'-W','ignore::DeprecationWarning','tools/visby-tree-pilot/round5_author.py'],cwd=ROOT,check=True)
    subprocess.run(['node','tools/visby-tree-pilot/round5-compile.mjs'],cwd=ROOT,check=True)
