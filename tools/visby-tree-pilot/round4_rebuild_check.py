...
def main():
    ...
    subprocess.run([sys.executable,'-W','ignore::DeprecationWarning','tools/visby-tree-pilot/round4_author.py'],cwd=ROOT,check=True)
    subprocess.run(['node','tools/visby-tree-pilot/round4-compile.mjs'],cwd=ROOT,check=True)
