...
import {OUT,serve,save,json} from './round6-preview.mjs';
const round='round6';
...
const servers={before:await serve('round5'),after:await serve(round||'after')};
...
save(path.join(work,reportPrefix+'-summary.json'),{browser:browser.version(),repeats,hole:16,camera:'tee',viewport:[1440,900],comparison,
 comparisonModes:{before:'round five',after:'round six'},
