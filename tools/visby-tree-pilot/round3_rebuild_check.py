...
def main():
    ...
    subprocess.run([sys.executable,'-W','ignore::DeprecationWarning','tools/visby-tree-pilot/round3_author.py'],cwd=ROOT,check=True)
    subprocess.run(['node','tools/visby-tree-pilot/compile-preview.mjs','--round3'],cwd=ROOT,check=True)
