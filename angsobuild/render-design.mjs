/* Draw the reconciled Ängsö GK course from above, to be judged before 3D.
...
push(`<text x="0" y="-2" fill="#eaf3ec" font-size="13" font-weight="700">Ängsö Golfklubb — reconciled layout</text>`);
L.forEach(([c, t], i) => {
