/* The regression gate for upsala3d.html. Exits non-zero on anything that
...
const page = process.argv[2] || path.join(ROOT, 'upsala3d.html');
...
gate(P0.b64 === hf.hf0.b64 && P1.b64 === hf.hf1.b64,
  `heightfields: page b64 identical to upsalabuild/heightfields.json`);
{
