...
| Buildings | Five roofs use 7,069 finite triangles from actual 2021 laser returns at absolute RH 2000 elevations. Original footprint alignment is preserved. | Clubhouse/north facility coverage is 92.3%/89.7%; unsupported areas and perimeter walls remain open. Other three roofs cover 99.8–100%. The small shed is withheld. Facades are neutral approximations. |
