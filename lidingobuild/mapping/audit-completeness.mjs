...
const report = {
  ...
  environment: {
    ...
    water: { components: runtime.water.length, extentIsAcquisitionLimited: true,
      limitation: 'Coastal polygons end at the old source crop. They cannot define the full-world shoreline; new source coverage is required.' },
  },
  newOrthophoto: { usedForThisAudit: false, boundaryVerification: 'pending acquisition and per-hole source review' },
  surfaceRecords,
};
