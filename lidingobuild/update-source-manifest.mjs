...
artifact('golftraxx-survey-review', 'control', 'lidingobuild/mapping/golftraxx-survey-review.json', ['club-scorecard', 'imagery-municipal-2019', 'lidingo-osm-2026-09-07'], 'The survey measured against two records it never saw: the card (its six no-target holes are exactly the six par 3s) and the observed greens (all 18 centres on the right hole, 16 strictly inside, median 5.25 m). The median offset is far smaller than the scatter, so no shift is applied to either record.');
artifact('ground-rings-acquisition', 'acquisition', base + 'acquisition/ground-rings.json', ['terrain-lm-1m'], 'Seven nested Markhojdmodell ring levels to a 16,384 m root, read by authenticated range request. Level 0 reproduces all 64 published 1 m tiles to 0.005 m. Every sample of every level is finite and no sea fill has anything to justify: Markhojdmodell tiles the Baltic here with real depth, reaching -10.157 m.');
