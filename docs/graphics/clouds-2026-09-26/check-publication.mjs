// Proves the re-bake for the clouds batch refreshed only source identities:
// every tint, vista and scatter record and every water payload keeps its content.
// Run from the repository root after the bakes: node docs/graphics/clouds-2026-09-26/check-publication.mjs
...
fs.writeFileSync('docs/graphics/clouds-2026-09-26/publication-identity.json',
