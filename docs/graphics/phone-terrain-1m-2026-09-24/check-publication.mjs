// Proves the re-bake for the phone terrain policy refreshed only source identities:
// every tint, vista and scatter record and every water payload keeps its content.
// Run from the repository root after the bakes: node docs/graphics/phone-terrain-1m-2026-09-24/check-publication.mjs
...
fs.writeFileSync('docs/graphics/phone-terrain-1m-2026-09-24/publication-identity.json',
