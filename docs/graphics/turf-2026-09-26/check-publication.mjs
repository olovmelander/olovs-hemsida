// Proves the re-bake for the turf batch refreshed source identities and moved
// nothing: every tint, vista, scatter and water payload keeps its content, its
// construction and its bytes. The batch is drawn, not prepared: the grain, the
// wear, the damp and the bare ground are all in the ground material's shader.
// Run from the repository root after the bakes: node docs/graphics/turf-2026-09-26/check-publication.mjs
...
fs.writeFileSync('docs/graphics/turf-2026-09-26/publication-identity.json',
