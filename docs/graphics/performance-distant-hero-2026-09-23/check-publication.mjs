...
fs.writeFileSync('tools/reference/rtx3070/prototype-publication-identity.json', JSON.stringify({ baseline: 'a93f79e6', build: JSON.parse(fs.readFileSync('tools/reference/distant-hero-build/course-startup-build.json')), results }, null, 2) + '\n');
