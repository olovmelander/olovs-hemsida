// Proves the re-bake for the glow batch refreshed only source identities:
// every tint, vista and scatter record and every water payload keeps its content.
// Run from the repository root after the bakes: node docs/graphics/glow-2026-09-25/check-publication.mjs
...
fs.writeFileSync('docs/graphics/glow-2026-09-25/publication-identity.json',
