# Historical development notebook — archived 21 September 2026

This is the retained historical body of the former root `CLAUDE.md`. Its dated
measurements, source decisions and lessons remain evidence. Statements about
current pages, renderers, opt-ins, fallback behavior and working practices may
be superseded. Follow [current development guidance](../../CLAUDE.md) and the
[course production workflow](../course-production-workflow.md) for new work.

Commands and code paths below are relative to the repository root. Relative
Markdown links have been adjusted for this archive's location. The historical
text has otherwise been retained in full.
...
[`docs/courses/norrfallsviken-source-dossier.md`](../courses/norrfallsviken-source-dossier.md).
...
[`docs/courses/puttom-source-dossier.md`](../courses/puttom-source-dossier.md).
...
[`docs/courses/ribbingsfors-source-dossier.md`](../courses/ribbingsfors-source-dossier.md)
...
[`docs/courses/visby-source-research.md`](../courses/visby-source-research.md)
